...
public class CutSceneManager : MonoBehaviour
{
    ...
    private IEnumerator easeObj(GameObject obj, float easingAmount=0){
    ...
    private Vector3 InfoToVector2(string information){//Turns the string info in cut scene scriptable to a vector
        string x = "", y = "", z = "";
    ...
    private float InfoToFloat(string information){//Turns the string info in cut scene scriptable to a vector
        string speed = "";
        //This gets a sub string from the ( char all the way to the end: EX: add(0, 3) -> (0, 3, 2) sub string
        information = information.Substring(information.IndexOf('(')+1);
